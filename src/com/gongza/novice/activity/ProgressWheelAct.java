...
import com.gongza.views.ProgressWheel;

/**
 * ProgressWheel符合Material Design风格
 * @author gongza
 *
 */
public class ProgressWheelAct extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_porgresswheel);
							...
							progressWheelInterpolated
									.setCallback(new ProgressWheel.ProgressCallback() {
										...
										public void onProgressUpdate(
											...
											interpolatedValue.setText(String
													.format("%.2f", progress));
										}
									});
							...
							progressWheelLinear
									.setCallback(new ProgressWheel.ProgressCallback() {
										...
										public void onProgressUpdate(
											...
											linearValue.setText(String.format(
													"%.2f", progress));
										}
									});
							break;
	...
	private void setProgress(float progress) {
		...
		progressWheelInterpolated
				.setCallback(new ProgressWheel.ProgressCallback() {
					@Override
					public void onProgressUpdate(float progress) {
						interpolatedValue.setText(String.format("%.2f",
								progress));
					}
				});
